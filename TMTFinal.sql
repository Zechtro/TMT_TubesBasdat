...
('12 Steps AA Companion - Alcoholics Anonymous','2020-07-22',468500,30367,'Support for sobriety with tools and resources based on the 12 Steps of Alcoholics Anonymous','TALEROCK322@gmail.com',NULL),
('7 Days to Die','2020-06-10',675,9410663,'Open-world survival horror where you craft  build  and fight off hordes of zombies. Every seventh day  the horde gets especially vicious','Loria513@gmail.com',NULL),
('ABC News - US & World News + Live Video','2020-03-14',0,98108,'Get breaking news in-depth reporting and live video coverage from ABC News','illegaldogs323@gmail.com',NULL),
('AccuWeather - Weather for Life','2020-10-17',443500,181941,'Get reliable weather forecasts radar and important weather alerts for daily planning','Enitvare931@gmail.com',NULL),
('Allrecipes Dinner Spinner','2020-11-22',0,36399,'Get daily recipe inspiration and solve the What\'s for dinner? dilemma with a touch of fun','Antarsoft714@gmail.com',NULL),
('ARK: Survival Evolved','2020-07-27',794,3409626,'A survival game set in a world of dinosaurs and prehistoric creatures. Tame dinos  craft gear  build bases  and fight or ally with other players','LeeroyLin823@gmail.com',0),
('Assetto Corsa Competizione','2020-08-04',165,11485548,'A hyper-realistic sim racing game officially licensed by the GT World Challenge. Masterfully recreates the feel of driving GT3 and GT4 race cars','Ideographer977@gmail.com',NULL),
('Baba is You Soundtrack','2020-12-18',0,453779,'Minimalist chiptune melodies and ambient soundscapes cleverly reflect the game\'s unique puzzle mechanics and mind-bending logic','Coredumping903@gmail.com',NULL),
('Bank of America - ElectornicBanking','2020-06-28',327500,160925,'Manage your finances track spending pay bills and make transfers with Bank of America\'s mobile app','gnomearc969@gmail.com',NULL),
('Bastion Soundtrack','2020-02-24',30000,124501,'Acoustic guitar folksy vocals and a hint of electronic twang create a unique Western-esque soundscape for a world on the brink','RebRank162@gmail.com',NULL),
('Bible','2020-03-21',0,92774,'Read and study the Bible with various translations and study tools','Loria513@gmail.com',NULL),
('Big Day - Event Countdown','2020-08-20',0,13156,'Get excited for upcoming events! Track the time remaining with customizable countdowns reminders and beautiful backgrounds','Sockware982@gmail.com',NULL),
('Bloodborne Soundtrack','2020-08-09',40500,394452,'Ominous choirs bombastic orchestral arrangements and driving rhythms build a sense of gothic horror and relentless action. The soundtrack perfectly captures the oppressive atmosphere of Yharnam and the thrill of battling grotesque beasts','illegaldogs323@gmail.com',4),
('Borderlands 3','2020-10-11',784,18529419,'A chaotic and hilarious first-person shooter looter. Choose your Vault Hunter  blast through hordes of enemies for insane loot  and save the galaxy (with style)','Sockware982@gmail.com',NULL),
('Cities: Skylines','2020-09-09',156,38219771,'The ultimate city-building simulator. Plan your metropolis  manage traffic  and watch your city come to life','illegaldogs323@gmail.com',NULL),
('Cleartune - Chromatic Tuner','2020-02-05',38500,11423,'Fine-tune instruments with this precise chromatic tuner','LeeroyLin823@gmail.com',NULL),
('Conan Exiles','2020-07-06',733,19133263,'Survive in the brutal world of Conan the Barbarian. Build your kingdom  conquer enemies  and appease the gods in this gritty survival action RPG','Nerial706@gmail.com',NULL),
('Crypt of the Necrodancer Soundtrack','2020-08-28',0,730293,'Infectious chiptune beats with a dance music twist where every beat syncs to the game\'s rhythmic action','Loria513@gmail.com',NULL),
('Cuphead The Delicious Last Course Soundtrack','2020-04-24',0,34763,'A playful and energetic celebration of 1930s cartoon music with jazzy big band sounds ragtime and a touch of the whimsical','TALEROCK322@gmail.com',4),
('Cyberpunk 2077 Soundtrack','2020-05-19',20000,434841,'Gritty electronic textures pulsating basslines and a hint of retro-futurism paint a dystopian soundscape','illegaldogs323@gmail.com',NULL),
('Dark Souls III Soundtrack','2020-10-11',25000,353127,'Lamenting strings foreboding choirs and epic brass define a world of struggle against monstrous forces','LeeroyLin823@gmail.com',NULL),
('Dead by Daylight','2020-12-30',247,1397647,'An asymmetrical horror game where one player controls a brutal killer  and four others attempt to escape as survivors. Diverse killers and tense gameplay offer replayability','Enitvare931@gmail.com',0),
('Dead Cells','2020-04-10',300,41937286,'A rogue-lite “metroidvania” with fast-paced action combat  tough-but-fair gameplay  and a constant sense of discovery. Unlock new gear and abilities as you explore a sprawling  interconnected castle','TALEROCK322@gmail.com',NULL),
('Death Stranding Soundtrack','2020-03-02',5500,378375,'Emotive and brooding soundscapes by Low Roar blending haunting vocals with stark electronic textures reflecting the lonely odyssey theme','Slavitica442@gmail.com',NULL),
('Deep Rock Galactic','2020-03-04',647,29765152,'A co-op focused first-person shooter where you play space dwarves mining dangerous procedurally-generated caves. Fight off hordes of alien bugs and bring back the loot!','Enitvare931@gmail.com',NULL),
('Deezer - Listen to your Favorite Music & Playlists','2020-11-10',23000,127470,'Music streaming service with curated playlists and a massive song library','FrozenCrate632@gmail.com',NULL),
('Deliveries: a package tracker','2020-09-14',210000,30016,'Keep tabs on all your incoming shipments with easy tracking from various carriers','LeeroyLin823@gmail.com',2),
('Destiny 2','2020-09-10',247,38443052,'A free-to-play sci-fi MMO first-person shooter. Become a Guardian  wielding  fantastical powers to protect humanity  explore the solar system  and engage in intense PvE or PvP combat','brutalsoft951@gmail.com',NULL),
('Devil May Cry 5 Soundtrack','2020-06-28',31500,183737,'Bombastic rock and adrenaline-pumping electronic tracks propel intense combat with over-the-top style','brutalsoft951@gmail.com',NULL),
('Disco Elysium - The Final Cut','2020-02-17',274,47175658,'A wildly unique and narrative-driven RPG. Play as a troubled detective with a shattered memory  and solve a murder case in a gorgeously realized world','Sciman101885@gmail.com',NULL),
('Disco Elysium Soundtrack','2020-05-28',39500,173444,'Unconventional blend of jazz atmospheric synths and a touch of disco nostalgia creating a uniquely disorienting soundscape','Ideographer977@gmail.com',2),
('Divinity: Original Sin 2 - Definitive Edition','2020-03-16',764,8000770,'A classic-style RPG with deep tactical combat  a captivating story  and both single-player and co-op options.  Create your hero and forge your path in a world of magic and gods','Loria513@gmail.com',NULL),
('Don\'t Starve','2020-11-11',938,47292305,'A quirky wilderness survival game with a distinctive Tim Burton-esque art style. Gather resources  craft bizarre contraptions  and don\'t get eaten by monsters','RebRank162@gmail.com',NULL),
('Don\'t Starve Together','2020-12-23',114,35052075,'The standalone multiplayer version of the quirky wilderness survival game. Face the strange gothic world with friends  working together to gather resources  build structures  and survive','Vais740@gmail.com',NULL),
('Dota 2','2020-02-02',517,8910788,'A free-to-play MOBA (Multiplayer Online Battle Arena) known for its depth  complexity  and huge esports scene. Two teams of five choose heroes with unique abilities to destroy the enemy base','Indefatigable480@gmail.com',NULL),
('Dyson Sphere Program Soundtrack','2020-09-21',7500,281870,'Uplifting synth melodies with driving beats mirroring the awe and ambition of building massive structures in space','Antarsoft714@gmail.com',NULL),
('eBay: Best App to Buy Sell! Online Shopping','2020-12-22',131500,128512,'Marketplace for buying and selling new and used items through auctions or direct sales','Sockware982@gmail.com',4),
('Euro Truck Simulator 2','2020-03-15',128,27293743,'Relax and drive across a realistic depiction of Europe. Build your trucking company  customize your truck  and deliver cargo in a surprisingly zen experience','HQGames379@gmail.com',NULL),
('Europa Universalis IV','2020-05-27',763,20062107,'A grand historical strategy game  Choose a nation and guide it through centuries of history - diplomacy  warfare  trade  and exploration','Slavitica442@gmail.com',NULL),
('Evernote','2020-04-25',0,158578,'Note-taking app to capture ideas create to-do lists and centralize digital information','Coredumping903@gmail.com',NULL),
('Exo One Soundtrack','2020-12-27',40500,404346,'Ambient guitar textures and expansive synth pads create a feeling of cosmic exploration and wonder','Coredumping903@gmail.com',0),
('Facebook','2020-11-02',0,389879,'Connect with friends and family join groups share photos and videos and stay updated on news and events with Facebook\'s social networking platform','Loria513@gmail.com',2),
('Factorio','2020-05-29',517,16073002,'Build and automate massive factories on an alien planet. Manage resources  research technologies  and defend yourself from the planet\'s inhabitants','Ideographer977@gmail.com',NULL),
('Fez Soundtrack','2020-05-18',40000,688622,'Eclectic mix of chiptune melodies and glitch-inspired soundscapes creating a sense of retro-futurism and playful discovery','Nerial706@gmail.com',NULL),
('Final Fantasy VII Remake Soundtrack','2020-10-21',36000,892809,'A masterful reimagining of classic themes sweeping orchestral pieces triumphant battle music and emotional character motifs','TALEROCK322@gmail.com',5),
('Florence Soundtrack','2020-06-20',11000,998987,'A soundtrack centered around beautiful cello melodies reflecting themes of love loss and the passage of time','KazukiShiroma442@gmail.com',2.5),
('FTL Faster Than Light Soundtrack','2020-08-26',29500,42278,'A blend of atmospheric synths and chiptune nostalgia creates a sense of tense strategic space exploration','Sciman101885@gmail.com',NULL),
('gFlashPro - Flashcards & Tests','2020-10-30',398000,25997,'Create and study digital flashcards for effective learning and memorization','Loria513@gmail.com',2),
('Google Earth','2020-11-11',474500,37214,'Explore the world in 3D with satellite imagery maps and detailed geographical information','Loria513@gmail.com',NULL),
('Grand Theft Auto V','2020-07-02',248,7092562,'Immerse yourself in the criminal underbelly of Los Santos in this open-world action-adventure. Pull off heists  cause mayhem  or just explore the sprawling city and its surroundings','KazukiShiroma442@gmail.com',NULL),
('GRIS','2020-12-25',788,21426145,'A serene and evocative platformer with a focus on art  music  and light puzzle-solving. A journey of emotional growth told through a stunningly beautiful world','Ideographer977@gmail.com',3),
('Gris Soundtrack','2020-03-14',18000,445459,'Delicate piano sweeping strings and airy synthesizers portray a journey of emotional healing with a touch of the abstract','LeeroyLin823@gmail.com',3.5),
('Hades','2020-10-22',418,29345641,'A roguelike dungeon crawler set in the Greek Underworld. Play as Zagreus  son of Hades  and fight your way out with the help of Olympian gods','HQGames379@gmail.com',3.5),
('Hadestown (Original Broadway Cast Recording) Soundtrack','2020-05-04',32000,754748,'Folk blues and jazz reimagine the Greek myth of Orpheus and Eurydice with catchy melodies and powerful vocals','Enitvare931@gmail.com',NULL),
('Hearts of Iron IV','2020-06-15',455,5548323,'World War II grand strategy game. Choose a country and guide its military  economic  and political path through history\'s greatest conflict','Vais740@gmail.com',5),
('Hitman 3','2020-03-26',127,20350584,'Become the ultimate assassin  Agent 47  and travel the globe completing  elaborate and creative assassination missions. Experimentation and sandbox level design are key','FrozenCrate632@gmail.com',4),
('Hollow Knight','2020-11-13',175,41006966,'A beautiful and atmospheric metroidvania with challenging combat and a haunting  mysterious world to explore. Delve into the depths of a forgotten insect kingdom','brutalsoft951@gmail.com',NULL),
('Hollow Knight Soundtrack','2020-11-07',0,684061,'Haunting piano melodies and ambient soundscapes build a sense of mystery and melancholy exploration beneath the surface','Sockware982@gmail.com',NULL),
('Hotline Miami Soundtrack','2020-06-20',0,602888,'Thumping electronic beats infused with 80s retro vibes drive relentless action and neon-soaked violence','Sockware982@gmail.com',NULL),
('HotSchedules','2020-10-02',233500,82037,'Manage employee schedules streamline communication and optimize labor costs for restaurants hospitality businesses and other industries','Ideographer977@gmail.com',NULL),
('Hurricane Pro','2020-07-24',381000,29518,'Track hurricanes and tropical storms with in-depth data and forecast models','Nerial706@gmail.com',NULL),
('Hyper Light Drifter Soundtrack','2020-09-04',43000,346361,'Glitchy chiptune-inspired beats and ethereal synth washes creating a sense of retro-futurism and lonely exploration','Vais740@gmail.com',NULL),
('iFart - The Original Fart Sounds App','2020-07-28',464000,60320,'Pull pranks and unleash a symphony of comical fart noises for light-hearted amusement','RebRank162@gmail.com',NULL),
('Inside Soundtrack','2020-08-25',6000,751359,'Dark ambient drones distorted industrial sounds and unsettling orchestral moments creating a soundtrack as disquieting and mysterious as the game itself','Slavitica442@gmail.com',NULL),
('iQuran','2020-11-07',241000,70707,'Read and explore the Quran with translations and recitation options','Ideographer977@gmail.com',NULL),
('iReal Pro - Music Book & Play Along','2020-12-23',0,63283,'A valuable tool for musicians offering chord charts play-along backing tracks and practice functions','Ideographer977@gmail.com',NULL),
('iStellar','2020-06-10',271500,44241,'Stargazing app with interactive sky maps constellations and celestial object information','Slavitica442@gmail.com',4),
('iTranslate - Language Translator & Dictionary','2020-11-17',182000,287933,'Translate between numerous languages with text voice and even camera input','gnomearc969@gmail.com',NULL),
('Journey Soundtrack','2020-07-17',21000,444620,'Ethereal and emotive score that evolves with the player\'s pilgrimage subtly guiding the desert quest','Sciman101885@gmail.com',NULL),
('Juxtaposer','2020-09-19',198000,45229,'Create before and after image comparisons with overlay and slider effects','Sockware982@gmail.com',3.333333333),
('Katamari Damacy Soundtrack','2020-05-12',43000,720523,'A delightfully eclectic mix of Japanese pop jazz electronica and pure absurdity the soundtrack is as joyful as rolling up the world','FrozenCrate632@gmail.com',1),
('Kentucky Route Zero Soundtrack','2020-08-29',7500,26927,'Haunting Americana and folksy tunes echoing the sense of mystery and the melancholy of the magical-realist journey','Vais740@gmail.com',NULL),
('Kerbal Space Program','2020-03-08',27,12359698,'Build rockets and attempt to launch a loveable race of aliens - the Kerbals - into space (and beyond!).  A true physics sandbox with both hilarity and genuine scientific challenge','illegaldogs323@gmail.com',1),
('Lifesum Inspiring healthy lifestyle app','2020-08-24',403500,188017,'Nutrition tracker and healthy living guide with calorie counting recipes and workout plans','Ideographer977@gmail.com',NULL),
('Line Rider iRide','2020-04-09',0,1646,'Draw creative tracks and guide your sledder through physics-based challenges with this classic web game turned mobile app','Antarsoft714@gmail.com',4),
('LinkedIn','2020-02-24',0,273844,'Build your professional network connect with job opportunities advance your career and stay updated on industry news and insights','Sockware982@gmail.com',NULL),
('Lose It! Weight Loss Program and Calorie Counter','2020-09-05',256500,182054,'Track calories reach weight loss goals and find healthy recipes for balanced nutrition','LeeroyLin823@gmail.com',NULL),
('Machinarium Soundtrack','2020-10-18',30500,227629,'Whimsical melodies with a touch of melancholy often using acoustic and found-sound elements perfectly fitting a world of curious robots','Nerial706@gmail.com',2.5),
('Mileage Log | Fahrtenbuch','2020-04-11',328500,71203,'Easily log your mileage for business or tax purposes','brutalsoft951@gmail.com',NULL),
('Minecraft Soundtrack','2020-05-05',30500,509951,'Peaceful ambient soundscapes and gentle piano pieces provide a soothing backdrop to creativity and exploration','TALEROCK322@gmail.com',NULL),
('Monster Hunter: World','2020-11-03',633,17648464,'Team up with friends or go solo to hunt down colossal beasts in stunning ecosystems. Craft gear from your quarry and take on even greater challenges','Sockware982@gmail.com',NULL),
('Monument Valley Soundtrack','2020-06-26',18500,531826,'Ethereal soundscapes and shifting musical puzzles create a sense of geometric wonder and quiet contemplation','RebRank162@gmail.com',NULL),
('MotionX GPS','2020-02-27',150000,56481,'Track your outdoor adventures record your performance data and navigate with detailed maps','gnomearc969@gmail.com',NULL),
('Myst Soundtrack','2020-04-03',15500,361007,'Ethereal synths and atmospheric textures create a sense of mystery and otherworldly exploration','RebRank162@gmail.com',NULL),
('NieR Replicant ver.1.22474487139 Soundtrack','2020-09-25',0,290334,'Haunting vocals shifting musical styles from orchestral to experimental perfectly capturing the unsettling beauty of its world','Slavitica442@gmail.com',NULL),
('Night in the Woods Soundtrack','2020-05-24',13500,68227,'Indie-folk soundtrack tinged with nostalgia guitars synths and vocals capture small-town charm and youthful exploration','Loria513@gmail.com',NULL),
('No Man\'s Sky Soundtrack','2020-09-24',31000,817130,'Uplifting synth-driven soundscapes by 65daysofstatic capturing the awe and vastness of space exploration','TALEROCK322@gmail.com',NULL),
('NRJ Radio','2020-07-29',0,53426,'Listen to the popular French radio station NRJ on the go','illegaldogs323@gmail.com',1),
('OpenTable - Restaurant Reservations','2020-11-03',0,93420,'Easily discover restaurants make reservations and earn rewards for dining out','gnomearc969@gmail.com',2),
('Ori and the Will of the Wisps Soundtrack','2020-11-13',0,322318,'Lush orchestral arrangements underscore a journey filled with wonder beauty and poignant emotion','gnomearc969@gmail.com',NULL),
('Outer Wilds Soundtrack','2020-11-05',40000,497732,'Folk-influenced acoustic melodies and ambient soundscapes evoke a sense of cosmic mystery and melancholy exploration','Slavitica442@gmail.com',NULL),
('Oxenfree Soundtrack','2020-09-20',0,171890,'Shimmering synths and atmospheric textures with a touch of the supernatural creating a sense of mystery and unease','Enitvare931@gmail.com',NULL),
('Oxygen Not Included','2020-02-20',393,15487280,'A space-colony survival sim. Manage your duplicants  build elaborate systems to deal with heat  oxygen  waste  and much more','gnomearc969@gmail.com',NULL),
('Pandora - Music & Radio','2020-09-06',29000,130242,'Personalized streaming radio that creates stations based on your favorite songs and artists','LeeroyLin823@gmail.com',NULL),
('Path of Exile','2020-03-18',361,15736826,'A free-to-play isometric action RPG known for its deep character customization and complex item system. Grind for the best loot and perfect your build','FrozenCrate632@gmail.com',NULL),
('Payday 2','2020-02-28',863,41535981,'Team up for co-op heists in this crime-filled FPS. Case locations  objectives  and surprises keep each heist feeling fresh','TALEROCK322@gmail.com',NULL),
('PayPal - Send and request money safely','2020-09-15',0,227795,'Securely send payments receive money and manage your account online or on the go with PayPal\'s trusted platform','illegaldogs323@gmail.com',1),
('PCalc - The Best Calculator','2020-07-25',148500,49250,'Powerful scientific calculator with extensive features for everyday use and professionals','Loria513@gmail.com',NULL),
('Period Tracker Deluxe','2020-12-13',180500,40216,'Track menstrual cycles ovulation and fertility windows for women\'s health','brutalsoft951@gmail.com',NULL),
('Persona 5 Soundtrack','2020-12-05',0,516845,'Acid jazz funk and soulful vocals define a soundtrack brimming with style and rebellion. Its catchy melodies and high-energy tracks perfectly match the Phantom Thieves daring heists and battles against corruption','TALEROCK322@gmail.com',3),
('Planet Coaster','2020-02-10',236,24689411,'Design and manage the amusement park of your dreams in incredible detail. Build thrilling coasters  manage park operations  and keep your guests happy','Antarsoft714@gmail.com',4),
('Planet Zoo','2020-09-02',142,27619633,'Build and manage the ultimate zoo with breathtakingly realistic animals. Attention to animal welfare and conservation are key','Antarsoft714@gmail.com',NULL),
('Plants vs. Zombies Soundtrack','2020-02-13',16000,504111,'Oddball jazz with playful vocals creates a surprisingly catchy backdrop for the comical undead battle on your lawn','illegaldogs323@gmail.com',4),
('Portal 2','2020-09-11',985,14787301,'A first-person puzzle game with mind-bending physics and a hilarious  iconic storyline. Use portals to navigate impossible test chambers','Slavitica442@gmail.com',NULL),
('Project Zomboid','2020-05-03',628,44711184,'A hardcore zombie survival game where the real danger is often how you react. Scavenge supplies  fortify your base  and try to stay alive as long as possible','LeeroyLin823@gmail.com',3),
('ProPresenter Remote','2020-12-12',30500,46922,'Control presentations remotely on your ProPresenter equipped computer perfect for churches and presenters','illegaldogs323@gmail.com',NULL),
('Psychonauts Soundtrack','2020-03-21',0,565730,'Big band swing Latin rhythms and quirky orchestrations match the bizarre and colorful psychic world perfectly','Indefatigable480@gmail.com',5),
('RadarScope','2020-05-28',0,172772,'Advanced weather radar visualization tool for weather enthusiasts and professionals','gnomearc969@gmail.com',NULL),
('Rain World Soundtrack','2020-05-18',9000,755375,'Sparse ambient soundscapes punctuated by heavy rain and environmental noises building a sense of vulnerability and desolation','Slavitica442@gmail.com',3),
('RimWorld','2020-02-21',808,4166846,'A sci-fi colony simulator where you manage the lives of crash-landed colonists on a distant world.  Storytelling is key  as you deal with disasters  raiders  and the unique personalities of your survivors','Enitvare931@gmail.com',NULL),
('Risk of Rain 2','2020-08-19',972,45292393,'A roguelike third-person shooter with overwhelming odds and addictive progression. Fight through hordes of monsters with friends or solo  unlocking new survivors and powerful items','Indefatigable480@gmail.com',NULL),
('Risk of Rain 2 Soundtrack','2020-09-08',13500,579202,'Driving electronic beats and progressive rock intensity fuel a sense of relentless action against overwhelming odds','brutalsoft951@gmail.com',NULL),
('Rust','2020-08-18',785,34581433,'A brutal multiplayer survival game where trust is hard-earned. Scavenge  build  defend yourself from other players  and raid their bases if you dare','Sciman101885@gmail.com',NULL),
('Sable Soundtrack','2020-03-13',26000,847457,'A mix of Japanese Breakfast\'s atmospheric indie sound and ambient synth textures evoking a sense of quiet solitude and desert exploration','brutalsoft951@gmail.com',NULL),
('Sayonara Wild Hearts Soundtrack','2020-12-24',32500,32832,'A vibrant synth-pop soundtrack brimming with catchy melodies driving beats and euphoric vocals a perfect match for the game\'s neon-drenched rhythm adventure','Ideographer977@gmail.com',NULL),
('Shazam - Discover music artists videos & lyrics','2020-10-15',151000,147093,'Quickly identify songs playing around you with just a tap','LeeroyLin823@gmail.com',NULL),
('Sid Meier\'s Civilization VI','2020-11-19',488,41497964,'Turn-based historical strategy where you guide a chosen civilization from antiquity to the modern age. Diplomacy  warfare  science  and culture are your tools','illegaldogs323@gmail.com',NULL),
('Skyrim Soundtrack','2020-02-21',6500,873384,'Rousing orchestral pieces capture the grandeur of northern landscapes and the spirit of heroic adventure','RebRank162@gmail.com',NULL),
('Slay the Spire','2020-09-14',754,4810521,'A roguelike deck-building game where you climb a procedurally-generated spire  battling unique creatures and building a powerful deck of cards','RebRank162@gmail.com',NULL),
('Sonos Controller','2020-10-17',0,107983,'Manage your Sonos speaker system directly from your mobile device','Ideographer977@gmail.com',NULL),
('Star Walk - Find Stars And Planets in Sky Above','2020-07-11',214000,150195,'Explore the night sky in real-time with this interactive astronomy app. Identify stars constellations planets and satellites by pointing your device upwards','TALEROCK322@gmail.com',1),
('Stardew Valley','2020-12-04',903,47210940,'Escape the city and inherit your grandfather\'s farm in a charming pixel-art world. Farm  befriend townsfolk  explore mines  and create your ideal rural life','Indefatigable480@gmail.com',NULL),
('Stardew Valley Soundtrack','2020-02-03',20500,232672,'Charming country-folk tunes and cheerful chiptune melodies evoke the simple life and the warmth of a close-knit community','Sciman101885@gmail.com',NULL),
('Stellaris','2020-11-01',480,24475230,'A grand strategy game set in space. Build a galactic empire  explore the vastness of the cosmos  and encounter alien civilizations','gnomearc969@gmail.com',NULL),
('Subnautica','2020-03-21',335,44012061,'An underwater survival-adventure set on an alien ocean planet. Craft  explore  and unravel the mysteries of the deep while being mindful of your oxygen and the lurking creatures','Nerial706@gmail.com',NULL),
('Target','2020-09-30',435500,138754,'Find deals browse products and conveniently shop for essentials with the Target app','Sockware982@gmail.com',1),
('Team Fortress 2','2020-09-20',560,41348979,'This free-to-play stylized multiplayer FPS pits teams of quirky characters against each other in objective-based game modes. Known for its humor and enduring community','Coredumping903@gmail.com',5),
('Terraria','2020-09-10',919,32629711,'A  2D sandbox adventure where you can dig  build  and fight your way through fantastical worlds. Exploration and freedom are its hallmarks','FrozenCrate632@gmail.com',NULL),
('Terraria Soundtrack','2020-08-09',29500,61835,'A mix of chiptune adventure and light orchestral themes create a balance of whimsy and exploration','Enitvare931@gmail.com',NULL),
('The Binding of Isaac Rebirth Soundtrack','2020-10-22',0,537805,'Eerie and distorted chiptune melodies blended with orchestral elements creating a disturbing yet strangely compelling atmosphere','Vais740@gmail.com',NULL),
('The Elder Scrolls V: Skyrim','2020-08-07',117,6635304,'A legendary open-world RPG where you become the Dragonborn  a hero with the power to shout dragons out of the sky. Explore a vast world  join factions  and craft your own legend','Coredumping903@gmail.com',2),
('The Sims 4','2020-09-27',896,5793851,'The ultimate life simulator. Create your Sims  build their homes  shape their relationships  and direct their careers (or their chaos)','KazukiShiroma442@gmail.com',NULL),
('The Stanley Parable Soundtrack','2020-11-27',16000,548830,'Eerie ambient textures with an undercurrent of deadpan humor reflects the surreal and often unpredictable narrative','KazukiShiroma442@gmail.com',NULL),
('The Weather Channel: Forecast Radar & Alerts','2020-10-26',364500,199734,'Get accurate local weather forecasts detailed radar maps severe weather alerts and live weather news to stay prepared for any conditions','KazukiShiroma442@gmail.com',NULL),
('The Witcher 3 Wild Hunt Soundtrack','2020-03-21',23000,803601,'Swelling orchestral themes intertwine with Polish folk influences evoking a vast fantasy world of monsters and magic','Antarsoft714@gmail.com',NULL),
('The Witcher 3: Wild Hunt','2020-03-23',958,13693208,'Embark on a sprawling open-world RPG as Geralt of Rivia  a monster hunter searching for his adopted daughter amidst a war-torn land','Antarsoft714@gmail.com',NULL),
('Total War: Warhammer II','2020-07-05',760,48628385,'Massive fantasy strategy combining turn-based empire management with spectacular real-time battles. Choose your faction and conquer the Warhammer world','HQGames379@gmail.com',2),
('TouchOSC','2020-03-03',192000,4263,'Control music software and other applications remotely with a customizable touch interface','Sciman101885@gmail.com',4),
('Transistor Soundtrack','2020-10-18',12500,194097,'Jazzy vocals sultry electronic beats and a touch of melancholy define a neo-noir city steeped in intrigue','Indefatigable480@gmail.com',NULL),
('TripAdvisor Hotels Flights Restaurants','2020-06-20',167500,207907,'Your companion for finding and booking hotels flights and restaurants with reviews and comparisons','HQGames379@gmail.com',NULL),
('Undertale Soundtrack','2020-09-21',11500,524551,'Iconic chiptune melodies that range from playful and quirky to surprisingly heartfelt and nostalgic','KazukiShiroma442@gmail.com',NULL),
('Valheim','2020-06-21',420,21707755,'A Viking survival and exploration game set in a procedurally-generated world inspired by Norse mythology. Build  craft  sail  and fight for glory in Odin\'s name','brutalsoft951@gmail.com',2.5),
('VLC Remote','2020-08-06',316000,31505,'Control the popular VLC media player from your mobile device for convenient playback management','FrozenCrate632@gmail.com',0),
('Warframe','2020-05-11',397,12480731,'A free-to-play third-person shooter where you play as space ninjas  the Tenno. Fast-paced action and a focus on movement and abilities define its gameplay','gnomearc969@gmail.com',NULL),
('WeatherBug','2020-05-19',183500,100524,'Get detailed weather forecasts real-time radar and severe weather alerts to stay informed about conditions','FrozenCrate632@gmail.com',NULL),
('WeatherPro','2020-08-29',290500,69079,'Get reliable worldwide weather forecasts HD maps animated radar and severe weather alerts for planning outdoor activities with confidence','Sockware982@gmail.com',NULL),
('White Noise','2020-04-06',77500,44129,'Relax or focus with ambient soundscapes ranging from natural environments to soothing mechanical hums','FrozenCrate632@gmail.com',NULL),
('XCOM 2','2020-07-26',895,24384849,'Lead a resistance against an alien occupation in this turn-based tactics game. Strategize on a global scale  then take your squad into intense tactical missions','Coredumping903@gmail.com',NULL),
('Yahoo Sports - Teams Scores News & Highlights','2020-06-12',430500,130583,'Stay updated on your favorite sports with scores news and highlights','KazukiShiroma442@gmail.com',NULL),
('Yelp - Nearby Restaurants Shopping & Services','2020-06-16',321500,167407,'Find and review local businesses from restaurants to services and make informed decisions with Yelp\'s community-driven platform','illegaldogs323@gmail.com',NULL);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER rata_rata_rating
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER check_awards_trigger
...
CREATE TABLE `developer` (
  ...
  CONSTRAINT `chk_email_developer` CHECK (`email_developer` like '%@%.com')
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
('Aberration','ARK: Survival Evolved',794,'2022-02-09'),
('Beyond Light','Destiny 2',0,'2021-02-24'),
('Blood and Wine','The Witcher 3: Wild Hunt',958,'2023-11-05'),
('British GT Pack','Assetto Corsa Competizione',165,'2024-02-10'),
('Conservation Pack','Planet Zoo',142,'2021-10-13'),
('Darkness Falls Overhaul','7 Days to Die',0,'2024-03-10'),
('Dawnguard','The Elder Scrolls V: Skyrim',0,'2021-09-19'),
('Director\'s Cut','Borderlands 3',784,'2023-09-10'),
('Dragonborn','The Elder Scrolls V: Skyrim',117,'2021-09-29'),
...
('Genesis Part 1 & 2','ARK: Survival Evolved',794,'2024-05-05'),
...
('Hearthfire','The Elder Scrolls V: Skyrim',117,'2021-02-05'),
('Hearts of Stone','The Witcher 3: Wild Hunt',958,'2021-08-01'),
('Hellraiser','Dead by Daylight',247,'2023-12-09'),
('Iceborne','Monster Hunter: World',633,'2023-02-22'),
('Ideology','RimWorld',0,'2021-07-12'),
('Industries','Cities: Skylines',156,'2022-05-08'),
('Instruments Pack','Rust',785,'2023-02-21'),
('Isle of Siptah','Conan Exiles',0,'2022-11-22'),
('Jungle Inferno','Team Fortress 2',560,'2024-01-17'),
('Legacy Collection','Payday 2',863,'2022-03-26'),
('Leviathans Story Pack','Stellaris',480,'2023-05-08'),
('Lightfall','Destiny 2',247,'2023-01-18'),
('Mann vs Machine','Team Fortress 2',560,'2023-10-09'),
('Mass Transit','Cities: Skylines',156,'2023-08-25'),
('Multiple Animal Packs','Planet Zoo',142,'2022-02-12'),
('Multiple Expansions','The Sims 4',896,'2021-10-10'),
('Numerous Expansions','Europa Universalis IV',763,'2021-07-30'),
...
('Numerous Map Expansions','Euro Truck Simulator 2',128,'2021-05-21'),
('People of the Dragon','Conan Exiles',733,'2021-02-09'),
('Psycho Krieg and the Fantastic Fustercluck','Borderlands 3',784,'2023-12-16'),
('Reign of Giants','Don\'t Starve',938,'2023-03-19'),
('Resident Evil','Dead by Daylight',0,'2022-11-26'),
('Riders of Hyboria','Conan Exiles',733,'2021-04-12'),
('Rise and Fall','Sid Meier\'s Civilization VI',488,'2021-09-26'),
('Royalty','RimWorld',808,'2022-12-19'),
('Scorched Earth','ARK: Survival Evolved',794,'2021-10-28'),
('Shipwrecked','Don\'t Starve',938,'2022-08-18'),
('Snowfall','Cities: Skylines',156,'2023-06-07'),
('Stranger Things','Dead by Daylight',0,'2021-06-20'),
('Stuff Packs','The Sims 4',896,'2023-08-02'),
('The New War','Warframe',397,'2023-07-15'),
('The Second Dream','Warframe',397,'2022-06-14'),
('The Witch Queen','Destiny 2',247,'2023-02-03'),
('Tuning Packs','Euro Truck Simulator 2',0,'2023-10-31'),
('Undead Legacy','7 Days to Die',0,'2024-02-25'),
('Utopia','Stellaris',480,'2021-11-29'),
('Voice Props Pack','Rust',785,'2024-04-06'),
('War of the Chosen','XCOM 2',895,'2023-10-12');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER validasi_harga_dlc_on_insert
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER check_dlc_launch_date_trigger
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER validasi_harga_dlc_on_update
BEFORE UPDATE ON dlc
FOR EACH ROW
BEGIN
    DECLARE harga_game INT;
...
CREATE TABLE `forum` (
  ...
  CONSTRAINT `fk_forum_pengguna` FOREIGN KEY (`email_pengguna`) REFERENCES `pengguna` (`email_pengguna`),
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER check_forum_owner
...
CREATE TABLE `pengguna` (
  ...
  CONSTRAINT `chk_email_pengguna` CHECK (`email_pengguna` like '%@%.com')
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pengikut_developer` (
  ...
  KEY `email_developer` (`email_developer`),
  CONSTRAINT `fk_email_pengguna` FOREIGN KEY (`email_pengguna`) REFERENCES `pengguna` (`email_pengguna`) ON DELETE CASCADE ON UPDATE CASCADE,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER prevent_status_friends_to_pending
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER prevent_status_block_to_pending
BEFORE UPDATE ON status_pertemanan
FOR EACH ROW
BEGIN
...
--
-- Temporary table structure for view `the_achievers`
--

DROP TABLE IF EXISTS `the_achievers`;
/*!50001 DROP VIEW IF EXISTS `the_achievers`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `the_achievers` AS SELECT
 1 AS `username`,
  1 AS `judul_aplikasi`,
  1 AS `jumlah_achievement`,
  1 AS `total_waktu` */;
...
CREATE TABLE `vote_forum` (
  ...
  KEY `email_pengguna` (`email_pengguna`),
  CONSTRAINT `fk_vote_forum` FOREIGN KEY (`judul_forum`) REFERENCES `forum` (`judul_forum`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Final view structure for view `the_achievers`
--
...
/*!50001 VIEW `the_achievers` AS select `top_ten`.`username` AS `username`,`ap`.`judul_aplikasi` AS `judul_aplikasi`,`ap`.`jumlah_achievement` AS `jumlah_achievement`,`ap`.`total_waktu` AS `total_waktu` from ((select `p`.`email_pengguna` AS `email_pengguna`,`p`.`username` AS `username`,count(`ap`.`jumlah_achievement`) AS `COUNT(jumlah_achievement)` from (`pengguna` `p` join `aplikasi_pengguna` `ap` on(`p`.`email_pengguna` = `ap`.`email_pengguna`)) group by `p`.`email_pengguna` order by count(`ap`.`jumlah_achievement`) desc limit 10) `top_ten` join `aplikasi_pengguna` `ap` on(`top_ten`.`email_pengguna` = `ap`.`email_pengguna`)) */;
...
-- Dump completed on 2024-05-18 14:56:32
